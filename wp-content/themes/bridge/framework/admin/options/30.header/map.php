		...
		$panel3->addChild("enable_search_container",$enable_search_container);
			...
			$enable_search_container->addChild("group1",$group1);
				...
				$group1->addChild("row1",$row1);
					...
					$search_text_texttransform = new QodeField("selectblanksimple","search_text_texttransform","","Text Transform","This is some description",$options_texttransform);
				...
				$group1->addChild("row2",$row2);
					...
					$search_text_fontstyle = new QodeField("selectblanksimple","search_text_fontstyle","","Font Style","This is some description",$options_fontstyle);
					$row2->addChild("search_text_fontstyle",$search_text_fontstyle);
					$search_text_fontweight = new QodeField("selectblanksimple","search_text_fontweight","","Font Weight","This is some description",$options_fontweight);
			...
			$enable_search_container->addChild("group5",$group5);
				...
				$group5->addChild("row1",$row1);
					...
					$search_label_text_texttransform = new QodeField("selectblanksimple","search_label_text_texttransform","","Text Transform","This is some description",$options_texttransform);
				...
				$group5->addChild("row2",$row2);
					...
					$search_label_text_fontstyle = new QodeField("selectblanksimple","search_label_text_fontstyle","","Font Style","This is some description",$options_fontstyle);
					$row2->addChild("search_label_text_fontstyle",$search_label_text_fontstyle);
					$search_label_text_fontweight = new QodeField("selectblanksimple","search_label_text_fontweight","","Font Weight","This is some description",$options_fontweight);
	...
	$panel11->addChild("enable_side_area",$enable_side_area);
		...
		$panel11->addChild("enable_side_area_container",$enable_side_area_container);
			...
			$enable_side_area_container->addChild("group1",$group1);
				...
				$side_area_text_texttransform = new QodeField("selectblanksimple","side_area_text_texttransform","","Text Transform","This is some description",$options_texttransform);
