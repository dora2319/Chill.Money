...
$sidebarPage->addChild("panel1",$panel1);
	...
	$panel1->addChild("group1",$group1);
		...
		$group1->addChild("row1",$row1);
			...
			$sidebar_title_texttransform = new QodeField("selectblanksimple","sidebar_title_texttransform","","Text Transform","This is some description",$options_texttransform);
		...
		$group1->addChild("row2",$row2);
			...
			$sidebar_title_fontstyle = new QodeField("selectblanksimple","sidebar_title_fontstyle","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("sidebar_title_fontstyle",$sidebar_title_fontstyle);

			$sidebar_title_fontweight = new QodeField("selectblanksimple","sidebar_title_fontweight","","Font Weight","This is some description",$options_fontweight);
	...
	$panel1->addChild("group2",$group2);
		...
		$group2->addChild("row1",$row1);
			...
			$sidebar_text_texttransform = new QodeField("selectblanksimple","sidebar_text_texttransform","","Text Transform","This is some description",$options_texttransform);
		...
		$group2->addChild("row2",$row2);
			...
			$sidebar_text_fontstyle = new QodeField("selectblanksimple","sidebar_text_fontstyle","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("sidebar_text_fontstyle",$sidebar_text_fontstyle);

			$sidebar_text_fontweight = new QodeField("selectblanksimple","sidebar_text_fontweight","","Font Weight","This is some description",$options_fontweight);
	...
	$panel1->addChild("group3",$group3);
		...
		$group3->addChild("row2",$row2);
			...
			$sidebar_link_texttransform = new QodeField("selectblanksimple","sidebar_link_texttransform","","Text Transform","This is some description",$options_texttransform);
			...
			$sidebar_link_fontstyle = new QodeField("selectblanksimple","sidebar_link_fontstyle","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("sidebar_link_fontstyle",$sidebar_link_fontstyle);

			$sidebar_link_fontweight = new QodeField("selectblanksimple","sidebar_link_fontweight","","Font Weight","This is some description",$options_fontweight);
