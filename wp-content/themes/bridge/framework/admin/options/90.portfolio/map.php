...
$portfolioPage->addChild("panel2",$panel2);
	...
	$group4 = new QodeGroup("Title Style (Hover Text, Masonry Without Space and Masonry With Space (only image))","Define styles for title");
	...
	$group5 = new QodeGroup("Category Style (Hover Text, Masonry Without Space and Masonry With Space (only image))","Define styles for category");
