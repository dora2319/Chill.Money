...
$elementsPage->addChild("panel5",$panel5);
	...
	$panel5->addChild("group1",$group1);
		...
		$group1->addChild("row2",$row2);
			...
			$quote_link_blockqoute_fontstyle = new QodeField("selectblanksimple","quote_link_blockqoute_fontstyle","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("quote_link_blockqoute_fontstyle",$quote_link_blockqoute_fontstyle);
			$quote_link_blockqoute_fontweight = new QodeField("selectblanksimple","quote_link_blockqoute_fontweight","","Font Weight","This is some description",$options_fontweight);
...
$elementsPage->addChild('panel17', $panel17);
	...
	$panel17->addChild('group1', $group1);
		...
		$group1->addChild("row1",$row1);
			...
			$masonry_gallery_square_big_title_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_square_big_title_text_transform', '', 'Text Transform', '', $options_texttransform);
		...
		$group1->addChild("row2",$row2);
			...
			$masonry_gallery_square_big_title_font_style = new QodeField('selectblanksimple', 'masonry_gallery_square_big_title_font_style', '', 'Font Style', '', $options_fontstyle);
			$row2->addChild('masonry_gallery_square_big_title_font_style', $masonry_gallery_square_big_title_font_style);

			$masonry_gallery_square_big_title_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_square_big_title_font_weight', '', 'Font Weight', '', $options_fontweight);
	...
	$panel17->addChild('group2', $group2);
		...
		$group2->addChild("row1",$row1);
			...
			$masonry_gallery_square_big_text_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_square_big_text_text_transform', '', 'Text Transform', '', $options_texttransform);
		...
		$group2->addChild("row2",$row2);
			...
			$masonry_gallery_square_big_text_font_style = new QodeField('selectblanksimple', 'masonry_gallery_square_big_text_font_style', '', 'Font Style', '', $options_fontstyle);
			$row2->addChild('masonry_gallery_square_big_text_font_style', $masonry_gallery_square_big_text_font_style);

			$masonry_gallery_square_big_text_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_square_big_text_font_weight', '', 'Font Weight', '', $options_fontweight);
	...
	$panel17->addChild('group3', $group3);
		...
		$group3->addChild('row1', $row1);
			...
			$masonry_gallery_square_big_button_font_style = new QodeField('selectblanksimple', 'masonry_gallery_square_big_button_font_style', '', 'Font Style', '', $options_fontstyle);
			$row1->addChild('masonry_gallery_square_big_button_font_style', $masonry_gallery_square_big_button_font_style);

			$masonry_gallery_square_big_button_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_square_big_button_font_weight', '', 'Font Weight', '', $options_fontweight);
			$row1->addChild('masonry_gallery_square_big_button_font_weight', $masonry_gallery_square_big_button_font_weight);

			$masonry_gallery_square_big_button_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_square_big_button_text_transform', '', 'Text Transform', '', $options_texttransform);
	...
	$panel17->addChild('group8', $group8);
		...
		$group8->addChild("row1",$row1);
			...
			$masonry_gallery_square_small_title_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_square_small_title_text_transform', '', 'Text Transform', '', $options_texttransform);
		...
		$group8->addChild("row2",$row2);
			...
			$masonry_gallery_square_small_title_font_style = new QodeField('selectblanksimple', 'masonry_gallery_square_small_title_font_style', '', 'Font Style', '', $options_fontstyle);
			$row2->addChild('masonry_gallery_square_small_title_font_style', $masonry_gallery_square_small_title_font_style);

			$masonry_gallery_square_small_title_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_square_small_title_font_weight', '', 'Font Weight', '', $options_fontweight);
	...
	$panel17->addChild('group9', $group9);
		...
		$group9->addChild("row1",$row1);
			...
			$masonry_gallery_square_small_text_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_square_small_text_text_transform', '', 'Text Transform', '', $options_texttransform);
		...
		$group9->addChild("row2",$row2);
			...
			$masonry_gallery_square_small_text_font_style = new QodeField('selectblanksimple', 'masonry_gallery_square_small_text_font_style', '', 'Font Style', '', $options_fontstyle);
			$row2->addChild('masonry_gallery_square_small_text_font_style', $masonry_gallery_square_small_text_font_style);

			$masonry_gallery_square_small_text_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_square_small_text_font_weight', '', 'Font Weight', '', $options_fontweight);
	...
	$panel17->addChild('group10', $group10);
		...
		$group10->addChild('row1', $row1);
			...
			$masonry_gallery_square_small_button_font_style = new QodeField('selectblanksimple', 'masonry_gallery_square_small_button_font_style', '', 'Font Style', '', $options_fontstyle);
			$row1->addChild('masonry_gallery_square_small_button_font_style', $masonry_gallery_square_small_button_font_style);

			$masonry_gallery_square_small_button_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_square_small_button_font_weight', '', 'Font Weight', '', $options_fontweight);
			$row1->addChild('masonry_gallery_square_small_button_font_weight', $masonry_gallery_square_small_button_font_weight);

			$masonry_gallery_square_small_button_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_square_small_button_text_transform', '', 'Text Transform', '', $options_texttransform);
	...
	$panel17->addChild('group15', $group15);
		...
		$group15->addChild("row1",$row1);
			...
			$masonry_gallery_rectangle_portrait_title_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_title_text_transform', '', 'Text Transform', '', $options_texttransform);
		...
		$group15->addChild("row2",$row2);
			...
			$masonry_gallery_rectangle_portrait_title_font_style = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_title_font_style', '', 'Font Style', '', $options_fontstyle);
			$row2->addChild('masonry_gallery_rectangle_portrait_title_font_style', $masonry_gallery_rectangle_portrait_title_font_style);

			$masonry_gallery_rectangle_portrait_title_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_title_font_weight', '', 'Font Weight', '', $options_fontweight);
	...
	$panel17->addChild('group16', $group16);
		...
		$group16->addChild("row1",$row1);
			...
			$masonry_gallery_rectangle_portrait_text_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_text_text_transform', '', 'Text Transform', '', $options_texttransform);
		...
		$group16->addChild("row2",$row2);
			...
			$masonry_gallery_rectangle_portrait_text_font_style = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_text_font_style', '', 'Font Style', '', $options_fontstyle);
			$row2->addChild('masonry_gallery_rectangle_portrait_text_font_style', $masonry_gallery_rectangle_portrait_text_font_style);

			$masonry_gallery_rectangle_portrait_text_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_text_font_weight', '', 'Font Weight', '', $options_fontweight);
	...
	$panel17->addChild('group17', $group17);
		...
		$group17->addChild('row1', $row1);
			...
			$masonry_gallery_rectangle_portrait_button_font_style = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_button_font_style', '', 'Font Style', '', $options_fontstyle);
			$row1->addChild('masonry_gallery_rectangle_portrait_button_font_style', $masonry_gallery_rectangle_portrait_button_font_style);

			$masonry_gallery_rectangle_portrait_button_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_button_font_weight', '', 'Font Weight', '', $options_fontweight);
			...
			$masonry_gallery_rectangle_portrait_button_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_portrait_button_text_transform', '', 'Text Transform', '', $options_texttransform);
	...
	$panel17->addChild('group22', $group22);
		...
		$group22->addChild("row1",$row1);
			...
			$masonry_gallery_rectangle_landscape_title_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_title_text_transform', '', 'Text Transform', '', $options_texttransform);
		...
		$group22->addChild("row2",$row2);
			...
			$masonry_gallery_rectangle_landscape_title_font_style = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_title_font_style', '', 'Font Style', '', $options_fontstyle);
			$row2->addChild('masonry_gallery_rectangle_landscape_title_font_style', $masonry_gallery_rectangle_landscape_title_font_style);

			$masonry_gallery_rectangle_landscape_title_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_title_font_weight', '', 'Font Weight', '', $options_fontweight);
	...
	$panel17->addChild('group23', $group23);
		...
		$group23->addChild("row1",$row1);
			...
			$masonry_gallery_rectangle_landscape_text_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_text_text_transform', '', 'Text Transform', '', $options_texttransform);
		...
		$group23->addChild("row2",$row2);
			...
			$masonry_gallery_rectangle_landscape_text_font_style = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_text_font_style', '', 'Font Style', '', $options_fontstyle);
			$row2->addChild('masonry_gallery_rectangle_landscape_text_font_style', $masonry_gallery_rectangle_landscape_text_font_style);

			$masonry_gallery_rectangle_landscape_text_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_text_font_weight', '', 'Font Weight', '', $options_fontweight);
	...
	$panel17->addChild('group24', $group24);
		...
		$group24->addChild('row1', $row1);
			...
			$masonry_gallery_rectangle_landscape_button_font_style = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_button_font_style', '', 'Font Style', '', $options_fontstyle);
			...
			$masonry_gallery_rectangle_landscape_button_font_weight = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_button_font_weight', '', 'Font Weight', '', $options_fontweight);
			...
			$masonry_gallery_rectangle_landscape_button_text_transform = new QodeField('selectblanksimple', 'masonry_gallery_rectangle_landscape_button_text_transform', '', 'Text Transform', '', $options_texttransform);
