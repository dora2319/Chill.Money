...
$qodeTitleAnimations = new QodeMetaBox('page', 'Qode Scroll Title Animations', 'qode_show-page-title', array('yes'));
$qodeFramework->qodeMetaBoxes->addMetaBox('page_title_animations', $qodeTitleAnimations);
