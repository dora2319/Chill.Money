			...
			<div class="post_content_holder">
				<div class="post_image">
					...
					<?php if($_video_type == "youtube") { ?>
						<iframe name="fitvid-<?php the_ID(); ?>" src="//www.youtube.com/embed/<?php echo get_post_meta(get_the_ID(), "video_format_link", true);  ?>?wmode=transparent" wmode="Opaque" frameborder="0" allowfullscreen></iframe>
					<?php } elseif ($_video_type == "vimeo"){ ?>
						<iframe name="fitvid-<?php the_ID(); ?>" src="//player.vimeo.com/video/<?php echo get_post_meta(get_the_ID(), "video_format_link", true);  ?>?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
					...
					<div class="post_text_inner">
						<div class="post_text_holder">
							...
							<div class="blog_column2">
								...
								<div class="post_info">
									<div class="post_info_left">
										<span class="blog_time"><?php the_time('d F Y'); ?> / </span>
										<?php the_category(' / '); ?>
										<?php if($blog_hide_author == "no") { ?>
											<span class="post_author">
												<a class="post_author_link" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"> / <?php the_author_meta('display_name'); ?></a>
